  ...
  it(
    ...
    async () => {
      ...
      expect(headers).toContain(
        'headersCollector examined this route and reported no required header for it. Where it ' +
          'read one and could not state it, the doctor report says why.',
      );
      ...
      expect(headers).toContain(
        'title="headersCollector examined this route and reported no required header for it.',
      );
    },
    TIMEOUT,
  );
